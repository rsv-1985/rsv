...
$lang['text_sample_info'] = 'Укажите соответствие колонок в Вашем прайсе';
$lang['text_sample_currency'] = 'Валюта прайс листа';
$lang['text_sample_category'] = 'Категория по умолчанию';
$lang['text_sample_default_term'] = 'Срок поставки по умолчанию (в часах)';
...
$lang['text_success_import'] = 'Данные обработаны о помещены во временную таблицу, проверьте их и продолжите импорт. Товары в которых Артикул = "", Производитель = "", Цена поставки = 0, Количество = 0 были очищены.';
