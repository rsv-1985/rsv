...
$lang['text_import_settings_delete'] = 'Удалить все ценовые предложения поставщика';
...
$lang['text_update_product_card'] = 'Обновить карточку товара';
$lang['text_update_product_card_description'] = 'Обновится назвние, описание, картинка, привязка к категории';
$lang['text_update_seo_url'] = 'Обвновить SEO url товаров';
$lang['text_update_seo_url_description'] = 'Поменяется ссылка на товар';