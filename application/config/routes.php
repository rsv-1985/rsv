...
$route['catalog/(:any)/(:any)'] = 'catalog/tree/$1/$2';
$route['catalog/(:any)'] = 'catalog/model/$1';
$route['product/(:any)'] = 'product/index/$1';
$route['news/(:any)'] = 'news/index/$1';
$route['category/(:any)/brand/(:any)'] = 'category/view/$1/$2';
$route['category/(:any)/brand/(:any)/:num'] = 'category/view/$1/$2/$3';
$route['category/(:any)/:num'] = 'category/view/$1/$2';
