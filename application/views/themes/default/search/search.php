                ...
                <div class="col-md-3">
                    ...
                    <div class="list-group">
                        <?php foreach ($brands as $brand){?>
                            <a href="/search?search=<?php echo $brand['sku'];?>&ID_art=<?php echo $brand['ID_art'];?>&brand=<?php echo $brand['brand'];?>" class="list-group-item <?php if($this->input->get('brand') == $brand['brand']){?> active<?php } ?>"><?php echo $brand['brand'];?><br>
