            ...
            <div class="box">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="textarea"><?php echo set_value('description');?></textarea>
                    </div><!-- /.form group -->
                    <div class="form-group">
                        <label><?php echo lang('text_comission'); ?></label>
                        <input type="text" class="form-control" name="comission" value="<?php echo set_value('comission'); ?>">
                    </div><!-- /.form group -->
                    <div class="form-group">
                        <label><?php echo lang('text_fix_cost'); ?></label>
                        <input type="text" class="form-control" name="fix_cost" value="<?php echo set_value('fix_cost'); ?>">
                    </div><!-- /.form group -->
                    <div class="form-group">
                    ...
                    <?php if($delivery_methods){?>
                        ...
                        <?php foreach ($delivery_methods as $dm){?>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="<?php echo $dm['id'];?>" name="delivery_methods[]">
                                    <?php echo $dm['name'];?>
                                </label>
                            </div>
                        <?php } ?>
