            ...
            <div class="box">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name="group_name" value="<?php echo set_value('brand1', $brand_group['group_name']); ?>" maxlength="60">
                    </div><!-- /.form group -->
                    <div class="form-group">
                        <label><?php echo lang('text_brands'); ?></label>
                        <input required type="text" class="form-control" name="brands" placeholder="MAHLE;KNECHT" value="<?php echo set_value('brands', $brands); ?>">
                    </div><!-- /.form group -->
                    <div class="form-group">
