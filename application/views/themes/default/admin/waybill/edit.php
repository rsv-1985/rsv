                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="paid" class="form-control">
                                <option></option>
                                <option value="1" <?php echo set_select('paid',1, '1' === $this->input->get('paid')); ?>>Оплачен</option>
                                <option value="0" <?php echo set_select('paid',0, '0' === $this->input->get('paid')); ?>>Не оплачен</option>
                            </select>
                        </div>
                        <div class="col-md-12">
                        ...
                        <table class="table table-striped">
                            ...
                            <?php foreach ($orders as $order) { ?>
                                <tr id="row<?php echo $order['id'];?>">
                                    ...
                                    <td>
                                        <button class="btn btn-default pull-right" onclick="addOrder(<?php echo $order['id'];?>,<?php echo $waybill_id;?>, <?php echo $this->input->get('status_id');?>, event)">Добавить в путевой</button>
                                    </td>
                                </tr>
                            <?php } ?>
                            </thead>
                    ...
                    <?php if ($parcels) { ?>
                        <table class="table table-striped table-hover">
                            ...
                            <?php foreach ($parcels as $parcel){?>
                                <tr>
                                <td><a href="#" class="btn btn-danger btn-xs" title="Удалить посылку" onclick="delete_waybill_parcel(<?php echo $parcel['id'];?>)"><i class="fa fa-trash-o"></i></a> </td>
                                ...
                                <td>
                                    ...
                                    <ul>
                                        <?php foreach ($parcel['products'] as $product){?>
                                            <li><?php echo $product['sku'] . ' ' . $product['brand'] . ' ' . $product['name']; ?>  (<?php echo $product['quantity'];?>шт) (<?php echo $product['sname'];?>) <a href="#" class="btn btn-danger btn-xs" title="Удалить товар с посылки" onclick="delete_waybill_product(<?php echo $product['id'];?>);"><i class="fa fa-trash-o"></i></a> </li>
                                        <?php } ?>
                                    </ul>
                                    <?php }else{?>
                                ...
                                <td><input name="ttn[<?php echo $parcel['id'];?>]" value="<?php echo $parcel['ttn'];?>" type="text" class="form-control"></td>
                            </tr>
                            <?php } ?>
                            </thead>
                        </table>
