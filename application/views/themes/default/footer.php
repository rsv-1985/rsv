                    ...
                    <ul>
                        <?php if ($this->footer_page) { ?>
                            <?php foreach ($this->footer_page as $fpage) { ?>
                                <li><a target="<?php echo $fpage['target']; ?>"
                                       href="<?php echo $fpage['href']; ?>"><?php echo $fpage['menu_title']; ?></a></li>
                            <?php } ?>
                        <?php } ?>
                    </ul>
                </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-menu">
                    <ul>
                        ...
                        <?php } ?>
                        <li>
                            <i class="fa fa-map-marker"></i> <?php echo $this->contacts['city']; ?> <?php echo $this->contacts['address']; ?>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="fast-order-body">
                ...
                <input type="hidden" name="href" id="fast-order-product" value="" required="required">
                <div class="form-group">
                    <label>Имя</label>
