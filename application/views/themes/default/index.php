        ...
        <div class="block-slider block-slider4">
            <ul class="" id="bxslider-home4">
                <?php foreach ($slider as $slider) { ?>
                    <li>
                        <a href="<?php echo $slider['link'];?>" <?php if($slider['new_window']){?>target="_blank" <?php } ?>>
                            <img src="/image?img=/uploads/banner/<?php echo $slider['image']; ?>&height=300" alt="<?php echo $slider['name']; ?>">
                ...
                <?php foreach ($box as $box) { ?>
                    <div class="col-md-3 col-sm-6">
                        <div class="single-promo promo1">
                            <img src="/image?img=/uploads/banner/<?php echo $box['image']; ?>&width=263" alt="<?php echo $box['name']; ?>">
                        <span>
                    ...
                    <div class="panel-body">
                        <ul>
                            <?php foreach($news as $news){?>
                                <li><a href="/news/<?php echo $news['slug'];?>"><?php echo $news['name'];?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="single-wid-product">
                                <a href="/product/<?php echo $top_sellers['slug'];?>">
                                    <?php if($top_sellers['image']){?>
                                        <img src="/image?img=<?php echo $top_sellers['image'];?>&width=100" alt="<?php echo $top_sellers['name'];?>" class="product-thumb"></a>
                                    <?php } ?>
                                <h2><a href="/product/<?php echo $top_sellers['slug'];?>"><?php echo $top_sellers['name'];?></a></h2>
                        ...
                        <div class="single-wid-product">
                            <a href="/product/<?php echo $novelty['slug'];?>">
                                <?php if($novelty['image']){?>
                                    <img src="/image?img=<?php echo $novelty['image'];?>&width=100" alt="<?php echo $novelty['name'];?>" class="product-thumb"></a>
                                <?php } ?>
                            <h2><a href="/product/<?php echo $novelty['slug'];?>"><?php echo $novelty['name'];?></a></h2>
                            <div class="product-wid-price">
                    ...
                    <div class="brand-wrapper">
                        <div class="brand-list">
                            <?php foreach($carousel as $carousel){?>
                                <img src="/uploads/banner/<?php echo $carousel['image'];?>" alt="<?php echo $carousel['name'];?>">
                            <?php } ?>
                        </div>
                    </div>
                </div>
